...
char *temp_from_internet = "12";
char *text_from_internet = "04";
char *time_from_internet = "08";
...
unsigned char SPI_Read_Byte(void)
{
	...
	GPIO_ResetBits(W5500_SCK_PORT,W5500_SCK);
	for(i=0;i<8;i++)
	{
		GPIO_SetBits(W5500_SCK_PORT,W5500_SCK);
		rByte<<=1;
		rByte|=GPIO_ReadInputDataBit(W5500_MISO_PORT,W5500_MISO);
		GPIO_ResetBits(W5500_SCK_PORT,W5500_SCK);
	}
	return rByte;
}
...
void SPI_Send_Byte(unsigned char dt)
{
	...
	{	
		GPIO_ResetBits(W5500_SCK_PORT,W5500_SCK);
		if((dt<<i)&0x80)
			GPIO_SetBits(W5500_MOSI_PORT,W5500_MOSI);
		else
			GPIO_ResetBits(W5500_MOSI_PORT,W5500_MOSI);
		GPIO_SetBits(W5500_SCK_PORT,W5500_SCK);
	}
	GPIO_ResetBits(W5500_SCK_PORT,W5500_SCK);
}
...
* 输出    : 无
* 返回    : 无 
* 说明    : 延时是利用systick定时器产生的1毫秒的计数来实现的
*******************************************************************************/
...
void Load_Net_Parameters(void)
{
	...
	S1_Port[0] = 0x13;//加载端口0的端口号5000 
	S1_Port[1] = 0x90;

    S0_DIP[0]=116;      //加载端口0的目的IP地址
	S0_DIP[1]=62;
	S0_DIP[2]=81;
	S0_DIP[3]=138;

	S0_DPort[0] = 0x00;//加载端口0的目的端口号80
	S0_DPort[1] = 0x50;
    
	S1_DIP[0]=183;      //加载端口1的目的IP地址
	S1_DIP[1]=230;
	S1_DIP[2]=40;
	S1_DIP[3]=33;

	S1_DPort[0] = 0x00;//加载端口1的目的端口号80
	S1_DPort[1] = 0x50;
...
void W5500_Initialization(void)
{
    ...
    if(Detect_Gateway()!=0xff)//检查网关服务器
        printf("\r\n检查网关服务器!\r\n");
	Socket_Init(0);		//指定Socket(0~7)初始化,初始化端口0
    Socket_Init(1);
}
...
//获得数据点状态
u8 GetDatapointStatus(char* buf,char* datapoint,char* data)
{
    u8 i;
    char *p = strstr(buf,datapoint);

    if(p == NULL)
        return 0;
    p+=strlen(datapoint)+3;
    for(i=0;*(p+i)!='\"';i++)
        *(data+i)=*(p+i);
    *(data+i)='\0';
    return i;
...
//    memset(Rx_Buffer,0,sizeof(Rx_Buffer));
    ...
    GetDatapointStatus((char*)Rx_Buffer,"code",text_from_internet);
    
    GetDatapointStatus((char*)Rx_Buffer,"last_update",time_from_internet);
    
    GetDatapointStatus((char*)Rx_Buffer,"temperature",temp_from_internet);
 

    
    switch((u8)(*text_from_internet-0x30))
    {
        case 0:
        case 1:
        case 2:
        case 3:text_from_internet = "晴";break;
        case 4:text_from_internet = "多云";break;
        case 5:
        case 6:text_from_internet = "晴间多云";break;
        case 7:
        case 8:text_from_internet = "大部分多云";break;
        case 9:text_from_internet = "阴";break;
        case 10:text_from_internet = "阵雨";break;
        case 11:text_from_internet = "雷阵雨";break;
        case 12:text_from_internet = "雷阵雨伴有冰雹";break;
        case 13:text_from_internet = "小雨";break;
        case 14:text_from_internet = "中雨";break;
        case 15:text_from_internet = "大雨";break;
        case 16:text_from_internet = "暴雨";break;
        case 17:text_from_internet = "大暴雨";break;
        case 18:text_from_internet = "特大暴雨";break;
        case 19:text_from_internet = "冻雨";break;
        case 20:text_from_internet = "雨夹雪";break;
        case 21:text_from_internet = "阵雪";break;
        case 22:text_from_internet = "小雪";break;
        case 23:text_from_internet = "中雪";break;
        case 24:text_from_internet = "大雪";break;
        case 25:text_from_internet = "暴雪";break;
        case 26:text_from_internet = "浮尘";break;
        case 27:text_from_internet = "扬沙";break;
        case 28:text_from_internet = "沙尘暴";break;
        case 29:text_from_internet = "强沙尘暴";break;
        case 30:text_from_internet = "雾";break;
        case 31:text_from_internet = "霾";break;
        case 32:text_from_internet = "风";break;
        case 33:text_from_internet = "大风";break;
        case 34:text_from_internet = "飓风";break;
        case 35:text_from_internet = "热带风暴";break;
        case 36:text_from_internet = "龙卷风";break;
        case 37:text_from_internet = "冷";break;
        case 38:text_from_internet = "热";break;
        case 99:text_from_internet = "未知";break;
        default:text_from_internet = "未知";break;
    }
